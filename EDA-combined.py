...
fig, axes = plt.subplots(figsize=(12,6))
plt.plot(lob1['Temperature_Fahrenheit'], color='orange', linewidth=1.0, linestyle='-', label='week1')
plt.plot(lob2['Temperature_Fahrenheit'], color='green', linewidth=1.0, linestyle='-', label='week2')
plt.plot(lob3['Temperature_Fahrenheit'], color='blue', linewidth=1.0, linestyle='-', label='week3')
plt.plot(lob4['Temperature_Fahrenheit'], color='red', linewidth=1.0, linestyle='-', label='week4')
plt.title("Lobby_Temperature")
plt.legend()
